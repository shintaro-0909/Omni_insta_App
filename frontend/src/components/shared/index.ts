...
// Temporary simple component exports for build compatibility
// TODO: Implement proper unified dashboard components

// Simple placeholder components for now
export const UnifiedMetricCard = { template: '<div>Metric Card</div>' };
export const UnifiedStatusIndicator = {
  template: '<div>Status Indicator</div>',
};
export const UnifiedAlertPanel = { template: '<div>Alert Panel</div>' };
export const UnifiedDashboardHeader = {
  template: '<div>Dashboard Header</div>',
};
export const UnifiedSectionCard = { template: '<div>Section Card</div>' };

// Compatibility aliases for legacy component names
export const DashboardCard = UnifiedMetricCard;
export const MetricCard = UnifiedMetricCard;
export const StatusCard = UnifiedStatusIndicator;
export const StatusChip = UnifiedStatusIndicator;
export const DashboardActionButton = UnifiedDashboardHeader;
export const ProgressMetric = UnifiedMetricCard;
