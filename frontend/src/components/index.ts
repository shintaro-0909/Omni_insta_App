...
// Widget components
export { default as AIAdaptationDashboard } from './widgets/AIAdaptationDashboard.vue'
export { default as AIPredictionDashboard } from './widgets/AIPredictionDashboard.vue'
export { default as AccessibilityDashboard } from './widgets/AccessibilityDashboard.vue'
export { default as MonitoringDashboard } from './widgets/MonitoringDashboard.vue'
export { default as PerformanceDashboard } from './widgets/PerformanceDashboard.vue'
export { default as SecurityDashboard } from './widgets/SecurityDashboard.vue'
...
export { default as DashboardComponents } from './shared/DashboardComponents.vue'
