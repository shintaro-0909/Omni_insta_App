          ...
          <v-col cols="12">
            ...
            <v-list density="compact">
              <v-list-item>
                ...
                <v-list-item-subtitle>{{ schedule.title }}</v-list-item-subtitle>
              </v-list-item>
          ...
          <v-col cols="12">
            ...
            <v-list density="compact">
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>{{ schedule.runCount }}回</v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item v-if="schedule.retryCount > 0">
                ...
                <v-list-item-subtitle>{{ schedule.retryCount }}回</v-list-item-subtitle>
              </v-list-item>
            </v-list>
          </v-col>
        </v-row>
            ...
            <v-list density="compact">
              ...
              <template v-if="schedule.type === 'recurring'">
                <v-list-item>
                  ...
                  <v-list-item-subtitle>{{ weekdaysText }}</v-list-item-subtitle>
                </v-list-item>
                ...
                <v-list-item>
                  ...
                  <v-list-item-subtitle>{{ schedule.repeatRule.time }}</v-list-item-subtitle>
                </v-list-item>
              </template>
              ...
              <template v-if="schedule.type === 'random'">
                <v-list-item>
                  ...
                  <v-list-item-subtitle>
                    {{ schedule.repeatRule.minInterval }}分 〜 {{ schedule.repeatRule.maxInterval }}分
                  </v-list-item-subtitle>
                </v-list-item>
                ...
                <v-list-item v-if="schedule.repeatRule.timeWindow">
                  ...
                  <v-list-item-subtitle>
                    {{ schedule.repeatRule.timeWindow.start }} 〜 {{ schedule.repeatRule.timeWindow.end }}
                  </v-list-item-subtitle>
                </v-list-item>
              </template>
            </v-list>
...
import type { Schedule } from '@/stores/schedules'
