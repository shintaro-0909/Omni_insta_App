      ...
      <v-row class="mb-4">
        ...
        <v-col cols="12" md="4">
          <performance-metric
            ...
            unit="ms"
            :status="
              metrics.LCP ? getMetricStatus('LCP', metrics.LCP) : undefined
            "
        ...
        <v-col cols="12" md="4">
          <performance-metric
            ...
            unit="ms"
            :status="
              metrics.FID ? getMetricStatus('FID', metrics.FID) : undefined
            "
        ...
        <v-col cols="12" md="4">
          <performance-metric
            ...
            :decimal-places="3"
            :status="
              metrics.CLS ? getMetricStatus('CLS', metrics.CLS) : undefined
            "
      ...
      <v-row class="mb-4">
        ...
        <v-col cols="12" md="3">
          <performance-metric
            ...
            unit="ms"
            :status="
              metrics.FCP ? getMetricStatus('FCP', metrics.FCP) : undefined
            "
        ...
        <v-col cols="12" md="3">
          <performance-metric
            ...
            unit="ms"
            :status="
              metrics.TTFB ? getMetricStatus('TTFB', metrics.TTFB) : undefined
            "
            ...
            <div class="d-flex align-center">
              ...
              <div>
                <div class="font-weight-medium">
                  {{ $t('performance.pwaInstalled') }}
                </div>
                <div class="text-caption text-medium-emphasis">
                  {{
                    isPWAInstalled
                      ? $t('performance.pwaInstalledYes')
                      : $t('performance.pwaInstalledNo')
                  }}
                </div>
              </div>
            </div>
        ...
        <v-col cols="12" md="6">
          <v-card variant="outlined" class="pa-3">
            <div class="d-flex align-center">
              ...
              <div>
                <div class="font-weight-medium">
                  {{ $t('performance.connectionStatus') }}
                </div>
                <div class="text-caption text-medium-emphasis">
                  {{
                    isOnline
...
<script setup lang="ts">
  ...
  import PerformanceMetric from '../common/PerformanceMetric.vue';
