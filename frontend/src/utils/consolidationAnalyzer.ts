...
class ConsolidationAnalyzer {
  ...
  private initializePlans(): void {
    this.plans = [
...

      {
        ...
        name: 'セキュリティシステム統合',
        description: 'security.ts, securityMiddleware.ts, securityTesting.tsの統合',
        sourceFiles: [
          'utils/security.ts',
...

      {
        ...
        description: 'performance.ts, performanceInterceptor.ts, realTimeMonitoring.tsの統合',
        sourceFiles: [
...

      {
        ...
        name: 'インタラクションシステム統合',
        description: 'interactionEngine.ts, gestureRecognition.ts, spatialMath.tsの統合',
        sourceFiles: [
  ...
  analyzeConsolidationPlan(planId: string): any {
    ...
    // ファイル重要度システムによる影響分析
    const impactAnalysis = analyzeConsolidation(plan.sourceFiles, plan.targetFile)
