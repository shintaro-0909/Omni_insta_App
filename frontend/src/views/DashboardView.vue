        ...
        <v-row align="center" class="py-8">
          ...
          <v-col cols="12" md="4" class="text-center">
            <div class="hero-illustration">
              <v-icon icon="mdi-instagram" size="120" class="instagram-icon" />
    ...
    <v-container class="dashboard-content">
      ...
      <v-row class="mb-8">
        <v-col cols="12">
          ...
          <p class="section-subtitle">ワンクリックで素早く操作を開始できます</p>
        </v-col>
        ...
        <v-col cols="12">
          ...
          <v-card elevation="0" rounded="xl" class="simple-plan-card">
            <v-card-text class="pa-6">
              <div class="d-flex align-center justify-space-between">
                <div>
                  ...
                  <div class="text-body-2 text-grey-darken-1">
                    今月の投稿: {{ currentPlan.usedPosts }}/{{
                      currentPlan.maxPosts
                    }}
                  </div>
                </div>
                <v-btn
              ...
              <v-progress-linear
                :model-value="
                  (currentPlan.usedPosts / currentPlan.maxPosts) * 100
                "
                color="primary"
                height="8"
                rounded
      ...
      <v-row class="mb-6">
        <v-col cols="12" md="8">
          <v-card class="activity-card" elevation="0" rounded="xl">
            ...
            <v-card-actions>
              <v-btn color="primary" variant="text" to="/schedules">
                すべて見る
              </v-btn>
            </v-card-actions>
          </v-card>
        ...
        <v-col cols="12" md="4">
          <v-card elevation="2" class="mb-4">
            ...
            <v-card-actions>
              <v-btn color="primary" variant="text" to="/accounts">
                管理
              </v-btn>
            </v-card-actions>
          </v-card>
