<template>
  <v-container>
    ...
    <v-row class="mb-6">
      <v-col cols="12" md="8">
        <h1 class="text-h3 font-weight-bold">アカウント管理</h1>
    ...
    <v-row class="mb-6">
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="2" class="pa-4">
          ...
          <div class="text-body-2 text-grey-darken-1">連携アカウント数</div>
        </v-card>
      </v-col>
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="2" class="pa-4">
          ...
          <div class="text-body-2 text-grey-darken-1">アクティブ</div>
        </v-card>
      </v-col>
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="2" class="pa-4">
          ...
          <div class="text-body-2 text-grey-darken-1">期限切れ間近</div>
        </v-card>
      </v-col>
    </v-row>
    ...
    <v-dialog v-model="showDeleteDialog" max-width="400">
      <v-card>
        <v-card-title class="text-h6"> アカウントを削除 </v-card-title>
        <v-card-text>
          Instagram アカウント「@{{
    ...
    <v-snackbar v-model="showError" color="error" timeout="5000" location="top">
      ...
      <template #actions>
        <v-btn variant="text" @click="igAccountsStore.clearError">
          閉じる
        </v-btn>
      </template>
    </v-snackbar>
