    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <p class="hero-description">
          Discover the perfect design aesthetic for your Instagram scheduling
          app. From modern minimalism to cyberpunk futurism, each style tells a
          unique story.
        </p>
          ...
          >
            ...
            <div class="style-preview-container">
              ...
              <div class="preview-actions">
                <button
                  class="action-btn"
                  @click.stop="previewStyle(style.id)"
                  title="Quick Preview"
                >
                ...
                <button
                  class="action-btn"
                  @click.stop="compareStyle(style.id)"
                ...
                <button
                  class="action-btn"
                  @click.stop="favoriteStyle(style.id)"
                  title="Favorite"
                >
                  <i
                    :class="
        ...
        <div class="comparison-content">
          <div class="comparison-table">
            ...
            >
              ...
              >
                <component
                  :is="getFeatureDisplay(feature.type, style[feature.key])"
                />
              </div>
            </div>
          </div>
      ...
      <div class="preview-content" @click.stop>
        <div class="preview-header">
          ...
          <div class="preview-actions">
            <button
              class="preview-btn"
              @click="selectStyle(previewedStyle?.id)"
            >
              <i class="mdi mdi-arrow-right"></i>
              Select This Style
            </button>
...
<script setup lang="ts">
  ...
  const features = [
    {
      ...
      description:
        'Perfect adaptation to all screen sizes from mobile to desktop',
    },
    {
    ...
    },
    {
      ...
      description:
        'Optimized animations and efficient CSS for lightning-fast loading',
    },
    {
      icon: 'mdi-palette',
      title: 'Design System',
      description:
        'Consistent components and patterns across all interface elements',
    },
    {
      icon: 'mdi-heart',
    ...
    },
    {
      ...
      title: 'Clean Code',
      description:
        'Well-structured, maintainable Vue.js components with TypeScript',
    },
  ];
  ...
  const styles: Style[] = [
    {
      ...
      name: 'Modern',
      description:
        'Clean, contemporary design with subtle shadows and excellent typography',
    ...
    },
    {
      ...
      name: 'Cyberpunk',
      description:
        'Futuristic neon design with glitch effects and high-tech aesthetics',
      category: 'Creative',
    ...
    },
    {
      ...
      name: 'Glassmorphism',
      description:
        'Translucent glass-like effects with backdrop blur for modern appeal',
      category: 'Modern',
    ...
    },
    {
      ...
      name: 'Neumorphism',
      description:
        'Soft 3D effects with subtle depth and tactile visual language',
    ...
    },
    {
      ...
      name: 'Minimalist',
      description:
        'Ultra-clean design focusing on content with maximum simplicity',
      category: 'Professional',
      icon: 'mdi-minus',
      color: '#000000',
    ...
    },
    {
      ...
      name: 'Stylish',
      description:
        'Elegant design with premium aesthetics and sophisticated details',
      category: 'Professional',
      icon: 'mdi-diamond',
      color: '#667eea',
    ...
    },
    {
      ...
      description:
        '80s-inspired design with neon colors and nostalgic future vision',
      category: 'Creative',
      icon: 'mdi-triangle',
      color: '#ff006e',
  ...
  const featuredStyles = computed(() =>
    styles.filter(s => s.featured).slice(0, 3)
  );
