<template>
  <div class="demo-navigation" :class="navigationClasses">
      ...
      <div class="header-content">
        ...
        <div class="header-actions">
          ...
          >
            <i
              :class="
                darkMode ? 'mdi mdi-weather-sunny' : 'mdi mdi-weather-night'
              "
            ></i>
          </button>
          ...
          >
            <i
              :class="
                isFullscreen ? 'mdi mdi-fullscreen-exit' : 'mdi mdi-fullscreen'
              "
            ></i>
          </button>
        </div>
          ...
          >
            ...
            <div class="style-info">
              ...
              <div class="style-tags">
                <span v-for="tag in style.tags" :key="tag" class="tag">{{
                  tag
                }}</span>
              </div>
            </div>
    ...
    <nav
      class="page-selector"
      v-show="currentViewMode === 'single' && currentStyle"
    >
      <div class="selector-content">
            ...
            <div class="comparison-stats">
              ...
              <div class="stat">
                ...
                <div class="stat-bar">
                  <div
                    class="stat-fill"
                    :style="{ width: style.accessibility + '%' }"
                  ></div>
                </div>
              </div>
            </div>
      ...
      <div class="info-content">
        <div v-if="currentStyleInfo" class="style-details">
          ...
          <div class="tech-specs">
            ...
            <ul>
              <li v-for="spec in currentStyleInfo.specs" :key="spec">
                {{ spec }}
              </li>
            </ul>
          </div>
          ...
          <div class="use-cases">
            <h5>Best For</h5>
            <ul>
              <li v-for="useCase in currentStyleInfo.useCases" :key="useCase">
                {{ useCase }}
              </li>
            </ul>
          </div>
...
<script setup lang="ts">
  ...
  const viewModes: ViewMode[] = [
    {
      ...
      label: 'Single',
      icon: 'mdi-monitor',
      tooltip: 'View one style at a time',
    },
    {
      value: 'split',
      label: 'Split',
      icon: 'mdi-view-column',
      tooltip: 'Compare multiple styles',
    },
    {
      value: 'comparison',
      label: 'Compare',
      icon: 'mdi-compare',
      tooltip: 'Compare all styles',
    },
  ];
  ...
  const styleOptions: StyleOption[] = [
    {
      ...
      longDescription:
        'A contemporary design approach that emphasizes clean lines, subtle shadows, and excellent typography. Perfect for professional applications.',
      icon: 'mdi-star',
      color: '#2196f3',
    ...
    },
    {
      ...
      longDescription:
        'A bold, futuristic aesthetic inspired by cyberpunk culture. Features neon colors, glitch effects, and high-tech visual elements.',
    ...
    },
    {
      ...
      longDescription:
        'A modern design trend featuring translucent elements with backdrop blur effects, creating a frosted glass appearance.',
    ...
    },
    {
      ...
      longDescription:
        'Also known as "Soft UI", this style creates the illusion of extruded shapes through subtle shadows and highlights.',
    ...
    },
    {
      ...
      longDescription:
        'Stripped down to essentials, this style focuses on content and functionality with minimal visual distractions.',
      icon: 'mdi-minus',
      color: '#000000',
    ...
    },
    {
      ...
      longDescription:
        'A sophisticated design approach with premium aesthetics, elegant typography, and refined visual hierarchy.',
      icon: 'mdi-diamond',
      color: '#667eea',
    ...
    },
    {
      ...
      longDescription:
        'Inspired by 1980s vision of the future, featuring neon colors, chrome effects, and retro-futuristic elements.',
      icon: 'mdi-triangle',
      color: '#ff006e',
  ...
  const availableStyles = computed(() =>
    styleOptions.filter(
      s => !s.comingSoon && !selectedStyles.value.includes(s.id)
    )
  );
  ...
  const addToSplit = (styleId: string) => {
    if (
      selectedStyles.value.length < 4 &&
      !selectedStyles.value.includes(styleId)
    ) {
...
<style scoped>
  ...
  .preview-icon--cyberpunk {
    background: linear-gradient(45deg, #00ffff, #ff006e);
  }
  .preview-icon--glassmorphism {
    background: rgba(255, 255, 255, 0.3);
    backdrop-filter: blur(10px);
  }
  .preview-icon--neumorphism {
    background: #e6e6e6;
    color: #333;
    box-shadow:
      8px 8px 16px #bebebe,
  ...
  .preview-icon--minimalist {
    background: #000;
  }
  .preview-icon--stylish {
    background: linear-gradient(45deg, #667eea, #764ba2);
  }
  .preview-icon--retro {
