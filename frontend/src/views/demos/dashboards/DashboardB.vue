    ...
    <div class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        ...
        <v-btn
          ...
          @click="toggleSidebar"
        >
          <v-icon :icon="sidebarCollapsed ? 'mdi-menu' : 'mdi-menu-open'"></v-icon>
        </v-btn>
      </div>
        ...
        <div class="sidebar-footer">
          <div class="user-profile">
            <div class="profile-avatar">
              <img src="https://picsum.photos/40/40?random=100" alt="User Avatar" />
            </div>
      ...
      <div class="content-header">
        <div class="header-left">
          <div class="breadcrumb">
            ...
            <v-icon icon="mdi-chevron-right" size="16" class="breadcrumb-separator"></v-icon>
            ...
            >
              <template v-slot:selection="{ item }">
                <div class="selected-account">
                  <img :src="item.raw.avatar" :alt="item.raw.name" class="account-avatar" />
              ...
              <div class="performance-metrics">
                ...
                >
                  ...
                  <div class="metric-chart">
                    <canvas :ref="'metric-chart-' + metric.id" width="120" height="40"></canvas>
                  </div>
                </div>
              </div>

              <div class="performance-chart">
                <canvas ref="performanceChart" width="500" height="200"></canvas>
              </div>
            </div>
          </div>
              ...
              <div class="timeline-view">
                <div class="timeline-header">
                  <div class="timeline-nav">
                    <v-btn icon variant="text" size="small" @click="previousTimelineDay">
                      <v-icon icon="mdi-chevron-left"></v-icon>
                    </v-btn>
                    <span class="timeline-date">{{ timelineDate }}</span>
                    <v-btn icon variant="text" size="small" @click="nextTimelineDay">
                ...
                <div class="timeline-content">
                  <div class="timeline-hours">
                    <div v-for="hour in 24" :key="hour" class="hour-slot">
                      <span class="hour-label">{{ String(hour - 1).padStart(2, '0') }}</span>
                    </div>
                  </div>
              ...
              <div class="analytics-summary">
                <div class="summary-section">
                  ...
                  <div class="highlight-items">
                    <div v-for="highlight in weeklyHighlights" :key="highlight.id" class="highlight-item">
                ...
                <div class="summary-section">
                  ...
                  <div class="follower-chart">
                    <canvas ref="followerChart" width="300" height="120"></canvas>
                  </div>
                </div>
                ...
                <div class="summary-section">
                  ...
                  <div class="top-posts">
                    <div v-for="post in topPosts" :key="post.id" class="top-post-item">
          ...
          <div class="widget accounts-widget">
            ...
            <div class="widget-content">
              <div class="accounts-overview">
                <div v-for="account in managedAccounts" :key="account.id" class="account-overview">
                  ...
                  <div class="account-actions">
                    <v-btn variant="outlined" size="small" block>
                      管理
                    </v-btn>
                  </div>
                </div>
...
.timeline-post.scheduled .post-dot { background: #667eea; }
.timeline-post.pending .post-dot { background: #F59E0B; }
.timeline-post.draft .post-dot { background: #6B7280; }
...
.action-icon.action-primary { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
.action-icon.action-secondary { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
.action-icon.action-accent { background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); }
.action-icon.action-info { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
...
.highlight-icon.success { background: #10B981; }
.highlight-icon.positive { background: #667eea; }
.highlight-icon.info { background: #3B82F6; }
