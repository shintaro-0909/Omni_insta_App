...
const props = defineProps({
  ...
  style: {
    type: String as PropType<'filled' | 'outlined' | 'text' | 'elevated' | 'tonal'>,
    default: 'filled'
  },
...
.base-btn--icon.base-btn--xs { --btn-padding: 0.375rem; }
.base-btn--icon.base-btn--sm { --btn-padding: 0.5rem; }
.base-btn--icon.base-btn--md { --btn-padding: 0.75rem; }
.base-btn--icon.base-btn--lg { --btn-padding: 1rem; }
.base-btn--icon.base-btn--xl { --btn-padding: 1.25rem; }
...
.base-btn--stylish {
  ...
  --btn-font-weight: 600;
  background: linear-gradient(135deg, var(--btn-gradient-start, #667eea) 0%, var(--btn-gradient-end, #764ba2) 100%);
