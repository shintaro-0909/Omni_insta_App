      ...
      <div class="container">
                  ...
                  <div class="frequency-slider">
                    ...
                    <div class="frequency-preview">
                      ...
                      <span class="preview-value">{{
                        getFrequencyEstimate(autoSettings.frequency)
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-content">
                  <div class="time-grid">
                    <div
                      ...
                      class="time-card"
                      :class="{
                        active: autoSettings.timeSlots.includes(slot.id),
                      }"
                    ...
                    >
                      ...
                      <div class="time-effectiveness">
                        <div
                          class="effectiveness-circle"
                          :style="{ '--percentage': slot.effectiveness }"
                        >
                    ...
                    <div class="interval-controls">
                      <div class="interval-presets">
                        <div
                          ...
                          class="preset-chip"
                          :class="{
                            active: infiniteSettings.interval === preset.value,
                          }"
              ...
              <div class="weekly-calendar">
                ...
                <div class="calendar-grid">
                  <div
                    ...
                    class="calendar-day"
                    :class="{
                      active: weeklySettings.activeDays.includes(day.id),
                    }"
                  >
                    ...
                    <div
                      v-if="weeklySettings.activeDays.includes(day.id)"
                      class="day-times"
                    >
                      <div
                    ...
                    <div class="day-restriction">
                      ...
                      <div class="day-toggles">
                        <div
                          ...
                          class="day-toggle"
                          :class="{
                            active: randomSettings.allowedDays.includes(day.id),
                          }"
        ...
        <div v-if="currentStep === 2" class="wizard-step" key="preview">
          <div class="step-header">
            ...
            <p class="step-description">
              あなたの投稿スケジュールがどのように見えるかプレビューしましょう
            </p>
          </div>
    ...
    <div class="wizard-navigation">
      <div class="container">
        <div class="nav-content">
          ...
          <v-btn v-else color="primary" size="large" @click="completeWizard">
            設定を保存
...
<script setup lang="ts">
  ...
  const postingTypes: PostingType[] = [
    ...
    },
    {
      ...
      name: '無限投稿',
      description:
        'コンテンツライブラリから継続的に自動投稿してフォロワーを維持',
      icon: 'mdi-infinity',
  ...
  const getIntervalTime = (index: number) => {
    ...
    baseTime.setTime(
      baseTime.getTime() +
        (index - 1) * infiniteSettings.interval * 60 * 60 * 1000
    );
    return baseTime.toLocaleTimeString('ja-JP', {
      hour: '2-digit',
      minute: '2-digit',
    });
  };
...
<style scoped>
  ...
  .effectiveness-circle {
    ...
    background: conic-gradient(
      #f093fb 0% calc(var(--percentage) * 1%),
      #e2e8f0 calc(var(--percentage) * 1%) 100%
    );
    display: flex;
    align-items: center;
    justify-content: center;
