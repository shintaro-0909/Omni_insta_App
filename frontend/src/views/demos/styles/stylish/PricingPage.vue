      ...
      <div class="hero-content">
        <div class="hero-text" :class="{ 'fade-in': isLoaded }">
          ...
          <p class="hero-description">
            Select the perfect plan to elevate your Instagram presence. 
            Every tier is crafted for exceptional results.
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="plans-grid">
          ...
          >
            ...
            <div class="plan-pricing">
              ...
              <div v-if="billingCycle === 'yearly' && plan.yearlyDiscount" class="yearly-savings">
            ...
            <div class="plan-features">
              ...
              <ul class="features-list">
                ...
                >
                  <span class="feature-icon">{{ feature.premium ? '✨' : '✓' }}</span>
                  <span class="feature-text">{{ feature.text }}</span>
                  <span v-if="feature.highlight" class="feature-highlight">{{ feature.highlight }}</span>
                </li>
              </ul>
            </div>
            ...
            <div class="plan-stats">
              <div class="stat-grid">
                <div v-for="stat in plan.stats" :key="stat.label" class="stat-item">
      ...
      <div class="comparison-container">
        ...
        <div class="comparison-table">
          <div class="table-header">
            ...
            <div v-for="plan in pricingPlans" :key="plan.id" class="plan-column">
            ...
            >
              ...
              >
                <div class="feature-name">
                  ...
                  <span v-if="feature.tooltip" class="feature-tooltip" :title="feature.tooltip">?</span>
                </div>
                <div 
                  ...
                  class="feature-value"
                >
                  <span v-if="feature.values[plan.id] === true" class="check-icon">✓</span>
                  <span v-else-if="feature.values[plan.id] === false" class="cross-icon">×</span>
                  <span v-else class="value-text">{{ feature.values[plan.id] }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="enterprise-content">
          <div class="enterprise-text">
            ...
            <p class="enterprise-description">
              For organizations that demand the absolute pinnacle of social media management. 
        ...
        <div class="faq-grid">
          ...
          >
            <div class="faq-question">
              ...
              <div class="question-icon">{{ openFaq === index ? '−' : '+' }}</div>
            </div>
      ...
      <div class="cta-container">
        <div class="cta-content">
          ...
          <p class="cta-description">
            Join thousands of successful brands and creators who trust us with their social media excellence.
          </p>
...
const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Unlimited scheduled posts', premium: false, highlight: 'Most popular' },
...
const featureCategories = [
  {
    ...
    features: [
      ...
      {
        name: 'Monthly Posts',
        values: { starter: '100', professional: 'Unlimited', enterprise: 'Unlimited' }
      },
      {
    ...
    features: [
      {
        ...
        values: { starter: '24 hours', professional: '4 hours', enterprise: '1 hour' }
      },
      {
        name: 'Phone Support',
        values: { starter: false, professional: false, enterprise: true }
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We\'ll notify you when you\'re approaching your limits. You can either upgrade your plan or wait until the next billing cycle for your limits to reset.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Absolutely. We use enterprise-grade security measures, including SSL encryption, regular security audits, and SOC 2 compliance to protect your data.'
  },
  {
...
.enterprise-section {
  padding: 6rem 0;
  background: linear-gradient(135deg, rgba(120, 119, 198, 0.05) 0%, rgba(0, 0, 0, 0.8) 100%);
}
