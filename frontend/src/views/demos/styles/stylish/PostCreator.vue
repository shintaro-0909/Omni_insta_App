        ...
        <section class="media-section">
          <div class="section-header">
            ...
            <div class="media-controls">
              <button class="control-btn" :class="{ active: mediaType === 'image' }" @click="mediaType = 'image'">
                📸 Image
              </button>
              <button class="control-btn" :class="{ active: mediaType === 'video' }" @click="mediaType = 'video'">
                🎬 Video
              </button>
              <button class="control-btn" :class="{ active: mediaType === 'carousel' }" @click="mediaType = 'carousel'">
                🎠 Carousel
              </button>
            </div>
          </div>

          <div class="media-upload-area" @click="triggerUpload" @dragover.prevent @drop.prevent="handleDrop">
            <div v-if="!uploadedMedia.length" class="upload-placeholder">
              <div class="upload-icon">📁</div>
              <h3 class="upload-title">Drop your media here</h3>
              <p class="upload-description">Support for JPG, PNG, MP4 up to 50MB</p>
            ...
            <div v-else class="media-grid">
              ...
              >
                <div class="media-preview">
                  ...
                  <video v-else-if="media.type === 'video'" :src="media.url" muted></video>
                  <div class="media-overlay">
                    <button class="overlay-btn edit" @click.stop="editMedia(index)">✏️</button>
                    <button class="overlay-btn delete" @click.stop="removeMedia(index)">🗑️</button>
                  </div>
                </div>
          ...
          <div v-if="uploadedMedia[selectedMediaIndex]" class="media-editor">
            <div class="editor-header">
              ...
              <div class="editor-tools">
                <button class="tool-btn" :class="{ active: activeTool === 'crop' }" @click="activeTool = 'crop'">
                  🔲 Crop
                </button>
                <button class="tool-btn" :class="{ active: activeTool === 'filter' }" @click="activeTool = 'filter'">
                  🎨 Filter
                </button>
                <button class="tool-btn" :class="{ active: activeTool === 'text' }" @click="activeTool = 'text'">
                  📝 Text
                </button>
              </div>
            </div>
        ...
        <section class="caption-section">
          ...
          <div class="caption-editor">
            ...
            <div class="caption-tools">
              ...
              <div class="ai-tools">
                <button class="ai-btn" @click="generateCaption">✨ AI Generate</button>
                <button class="ai-btn" @click="improveCaption">🚀 Enhance</button>
              </div>
            </div>
          </div>
          ...
          <div class="settings-grid">
            ...
            <div v-if="scheduleType === 'later'" class="setting-group">
              ...
              <div class="datetime-inputs">
                <input type="date" v-model="scheduleDate" class="datetime-input" />
                <input type="time" v-model="scheduleTime" class="datetime-input" />
              </div>
            </div>
          </div>
              ...
              <div class="instagram-preview">
                <div class="post-header">
                  <div class="account-info">
                    <div class="account-avatar">
                      <img :src="selectedAccountData?.avatar" :alt="selectedAccountData?.name" />
                    </div>
                ...
                <div class="post-media">
                  <div v-if="uploadedMedia.length" class="media-container">
                    ...
                    <div v-if="uploadedMedia.length > 1" class="carousel-indicator">
                      <div 
                  ...
                  <div v-else class="media-placeholder">
                    ...
                    <span class="placeholder-text">Add media to see preview</span>
                  </div>
                </div>
                ...
                <div class="post-caption">
                  <span class="caption-username">{{ selectedAccountData?.username }}</span>
                  <span class="caption-text">{{ captionText || 'Your caption will appear here...' }}</span>
                </div>
      ...
      <div class="progress-modal">
        ...
        <div class="progress-content">
          ...
          <div class="progress-bar">
            <div 
              class="progress-fill" 
              :style="{ width: `${(currentStep / (publishSteps.length - 1)) * 100}%` }"
            ></div>
          </div>
        </div>
      </div>
...
const predictedComments = computed(() => {
  return Math.round(parseInt(predictedLikes.value.replace(/,/g, '')) * 0.08).toLocaleString()
})

const predictedShares = computed(() => {
  return Math.round(parseInt(predictedLikes.value.replace(/,/g, '')) * 0.03).toLocaleString()
})
...
const generateCaption = () => {
  captionText.value = "Embracing the journey of innovation and creativity ✨ Every moment is an opportunity to create something extraordinary. What inspires you today? #inspiration #creativity #innovation"
  updateCaptionStats()
}
