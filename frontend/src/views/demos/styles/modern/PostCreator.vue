          ...
          <v-col cols="auto">
            <div class="header-title-section">
              ...
              <p class="page-subtitle">
                Craft engaging content with AI-powered tools
              </p>
            </div>
          </v-col>
          <v-col cols="auto">
        ...
        <v-col cols="12" lg="8">
            ...
            <v-card-title class="upload-header">
              <div>
                ...
                <p class="upload-subtitle">
                  Upload photos, videos, or create carousels
                </p>
              </div>
              ...
              <div class="upload-area">
                ...
                >
                  <div class="dropzone-content">
                    ...
                    <v-btn color="primary" variant="flat" class="upload-btn">
                      Choose Files
                    </v-btn>
                  </div>
                </div>
                ...
                <div v-else class="media-grid">
                  ...
                  <!-- Add More Button -->
                  <div class="add-media-item" @click="triggerFileUpload">
          ...
          >
            <v-card-title class="caption-header">
              <div>
                ...
                <p class="caption-subtitle">
                  Craft engaging captions with AI assistance
                </p>
              </div>
            ...
            <v-card-text>
              ...
              <!-- AI Suggestions -->
              <div
                v-if="captionSuggestions.length > 0"
                class="caption-suggestions"
              >
              ...
              <div class="hashtag-generator">
                ...
                <div
                  v-if="recommendedHashtags.length > 0"
                  class="hashtag-recommendations"
                >
                  ...
                  <div class="hashtags-grid">
                    ...
                    >
                      #{{ hashtag.name }}
                      <v-icon end size="16">{{
                        hashtag.selected ? 'mdi-check' : 'mdi-plus'
                      }}</v-icon>
                    </v-chip>
                  </div>
                </div>
          ...
          >
            ...
            <v-card-text>
              ...
              <div v-if="scheduleType === 'optimal'" class="optimal-time-info">
                <v-alert type="info" variant="tonal" class="optimal-alert">
...
<script setup lang="ts">
  ...
  const rules = {
    maxLength: (value: string) =>
      value.length <= 2200 || 'Caption must be less than 2200 characters',
  };
