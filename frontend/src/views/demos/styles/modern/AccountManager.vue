          ...
          <v-col cols="auto">
            <div class="header-title-section">
              ...
              <p class="page-subtitle">
                Manage your connected Instagram accounts and analytics
              </p>
            </div>
          </v-col>
          <v-col cols="auto">
        ...
        >
          ...
          >
            <div class="stat-content">
              <v-avatar size="64" :class="`stat-icon stat-icon--${stat.color}`">
        ...
        <v-col cols="12" md="6" lg="4">
          ...
          >
            <div class="add-account-content">
              ...
              <v-btn color="primary" variant="flat" class="add-account-btn">
    ...
    <v-dialog v-model="showAddDialog" max-width="500px">
      <v-card class="add-dialog">
        ...
        <v-card-actions>
          ...
          <v-btn color="primary" variant="flat" @click="connectInstagram">
            <v-icon start>mdi-instagram</v-icon>
            Connect Instagram
          </v-btn>
        </v-card-actions>
