        ...
        <v-row align="center" justify="space-between">
          <v-col cols="auto">
            <div class="header-title-section">
              ...
              <p class="page-subtitle">Plan, organize, and automate your Instagram content</p>
            </div>
          </v-col>
          <v-col cols="auto">
    ...
    <v-container v-if="viewMode === 'timeline'">
      <v-card class="timeline-card" elevation="2" data-aos="fade-up">
        <v-card-title>
          ...
          <p class="timeline-subtitle">Visual overview of your posting schedule</p>
        </v-card-title>
        <v-card-text>
            ...
            <v-timeline side="end" class="schedule-timeline">
              ...
              >
                <template v-slot:icon>
                  <v-icon :icon="getTimelineIcon(item.status)" size="20"></v-icon>
                </template>
                      ...
                      <v-col>
                        <v-card-text class="timeline-details">
                          <div class="timeline-meta">
                            ...
                            <span class="timeline-account">@{{ item.account }}</span>
                          </div>
...
const filteredPosts = computed(() => {
  ...
  if (selectedAccount.value !== 'all') {
    filtered = filtered.filter(post => post.account === selectedAccount.value)
  }
