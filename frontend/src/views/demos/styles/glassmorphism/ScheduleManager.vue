    ...
    <v-container fluid class="pa-6">
      ...
      <div class="schedule-header mb-8">
        ...
        <p class="schedule-subtitle">
          Plan and organize your Instagram content calendar
        </p>
      </div>
      ...
      <div
        ...
        class="glass-card calendar-container mb-6"
      >
        ...
        >
          ...
          <div class="timeline-posts">
            <div
              ...
              :key="post.id"
              class="glass-card timeline-post"
            >
              <div class="post-time">
      ...
      <v-dialog v-model="scheduleDialog" max-width="600" persistent>
        <div class="glass-card dialog-content">
          ...
          <div class="dialog-actions mt-6">
            <v-btn class="glass-btn" @click="scheduleDialog = false"
              >Cancel</v-btn
            >
            <v-btn class="glass-btn primary-btn" @click="saveSchedule"
              >Schedule Post</v-btn
            >
          </div>
        </div>
...
<script setup lang="ts">
  ...
  const getTimelinePostsForDate = (date: Date) => {
    ...
    return times.slice(0, Math.floor(Math.random() * 3) + 1).map((time, i) => ({
      ...
      accountHandle: accounts.value[(i % 3) + 1].name
        .toLowerCase()
        .replace(' ', ''),
...
<style scoped>
  ...
  @keyframes wave {
    ...
    50% {
      transform: translateX(30%) translateY(-10%) rotate(180deg);
    }
    100% {
