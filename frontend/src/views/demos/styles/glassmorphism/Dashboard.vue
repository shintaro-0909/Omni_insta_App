  ...
  <div class="glassmorphism-dashboard">
    ...
    <v-container fluid class="pa-6">
      ...
      <div class="dashboard-header mb-8">
        ...
        <p class="dashboard-subtitle">Here's what's happening with your Instagram accounts today</p>
      </div>

      <!-- Stats Grid -->
      <v-row class="mb-8">
        <v-col v-for="stat in stats" :key="stat.title" cols="12" sm="6" md="3">
          <div class="glass-card stat-card" :style="{ '--accent-color': stat.color }">
            ...
            <div class="stat-content">
              ...
              <div class="stat-change" :class="stat.changeType">
                <v-icon size="16">{{ stat.changeType === 'up' ? 'mdi-trending-up' : 'mdi-trending-down' }}</v-icon>
        ...
        <v-col cols="12" md="4">
          <div class="glass-card upcoming-card">
            ...
            <div class="upcoming-list">
              <div v-for="post in upcomingPosts" :key="post.id" class="upcoming-item">
                <div class="post-time">
      ...
      <div class="glass-card quick-actions mt-6">
        ...
        <v-row>
          <v-col v-for="action in quickActions" :key="action.title" cols="12" sm="6" md="3">
            <v-btn class="glass-btn action-btn" block size="large" @click="action.action">
...
const metrics = ref([
  { label: 'Engagement Rate', value: '8.7%', percentage: 87, color: 'linear-gradient(90deg, #667eea 0%, #764ba2 100%)' },
  { label: 'Story Views', value: '12.4K', percentage: 72, color: 'linear-gradient(90deg, #f093fb 0%, #f5576c 100%)' },
  { label: 'Profile Visits', value: '3.2K', percentage: 65, color: 'linear-gradient(90deg, #4facfe 0%, #00f2fe 100%)' },
  { label: 'Click Rate', value: '5.3%', percentage: 53, color: 'linear-gradient(90deg, #fa709a 0%, #fee140 100%)' }
])
...
const getData = () => {
  switch (selectedFilter.value) {
    ...
    case '30 Days':
      return Array.from({ length: 30 }, () => Math.floor(Math.random() * 40) + 10)
    case '3 Months':
      return [450, 520, 480]
    default:
      return []
...
.glassmorphism-dashboard {
  min-height: 100vh;
  background: linear-gradient(135deg, #1e3c72 0%, #2a5298 25%, #7e22ce 50%, #ec4899 75%, #1e3c72 100%);
