      ...
      <div class="glass-card comparison-section">
        ...
        <div class="comparison-table">
          <div class="comparison-header">
            ...
            <div v-for="plan in comparisonPlans" :key="plan" class="plan-column">
              {{ plan }}
            </div>
          </div>
          <div v-for="category in featureCategories" :key="category.name" class="feature-category">
            ...
            <div v-for="feature in category.features" :key="feature.name" class="feature-row">
              <div class="feature-name">
                {{ feature.name }}
                <v-tooltip v-if="feature.tooltip" location="top">
                  <template v-slot:activator="{ props }">
                    <v-icon size="16" v-bind="props" class="ml-1">mdi-information-outline</v-icon>
                  </template>
...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 'Yes! You can upgrade, downgrade, or cancel your subscription at any time. Changes take effect at the next billing cycle, and we offer prorated refunds for downgrades.'
  },
  {
    icon: 'mdi-account-switch',
    question: 'Can I switch between monthly and annual billing?',
    answer: 'Absolutely! You can switch between monthly and annual billing at any time. When switching to annual, you\'ll receive a 20% discount immediately.'
  },
  {
    icon: 'mdi-shield-check',
    question: 'Is my Instagram account safe?',
    answer: 'Yes, we use official Instagram Graph API and never store your Instagram password. We\'re fully compliant with Instagram\'s terms of service and use industry-standard encryption.'
  },
  {
    icon: 'mdi-test-tube',
    question: 'Do you offer a free trial?',
    answer: 'Yes! All paid plans come with a 14-day free trial (30 days for Pro plan). No credit card required to start your trial.'
  }
])
...
.glassmorphism-pricing {
  min-height: 100vh;
  background: linear-gradient(135deg, #3D4E81 0%, #5753C9 25%, #6E7FF3 50%, #C850C0 75%, #FFCC70 100%);
