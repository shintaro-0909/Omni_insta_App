    ...
    <v-container fluid class="pa-6">
      ...
      <div class="accounts-header mb-8">
        ...
        <p class="accounts-subtitle">
          Manage and monitor all your Instagram accounts in one place
        </p>
      </div>
          ...
          >
            ...
            <div class="activity-section">
              ...
              <div class="activity-list">
                <div
                  v-for="activity in account.recentActivity"
                  :key="activity.id"
                  class="activity-item"
                >
...
<script setup lang="ts">
  ...
  const accounts = ref([
    {
      ...
      recentActivity: [
        ...
        { id: 2, type: 'story', text: 'Added to story', time: '5 hours ago' },
        {
          id: 3,
          type: 'engagement',
          text: 'Engagement spike detected',
          time: '1 day ago',
        },
      ],
    },
      ...
      recentActivity: [
        {
          id: 1,
          type: 'post',
          text: 'Scheduled post published',
          time: '4 hours ago',
        },
        {
          id: 2,
          type: 'follower',
          text: 'Gained 250 followers',
          time: '1 day ago',
        },
        {
          id: 3,
          type: 'mention',
          text: 'Mentioned by @influencer',
          time: '2 days ago',
        },
      ],
    },
  ...
  onMounted(() => {
    ...
    const comparisonCanvas = document.querySelector(
