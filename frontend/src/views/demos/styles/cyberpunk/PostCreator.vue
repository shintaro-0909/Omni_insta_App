          ...
          <div v-if="editorMode === 'visual'" class="visual-editor">
            <div class="caption-editor">
              ...
              <div class="caption-stats">
                <span
                  class="char-count"
                  :class="{ warning: characterCount > 2000 }"
                >
            ...
            <div class="hashtag-editor">
              ...
              <div class="hashtag-list">
                ...
                >
                  ...
                  <button class="tag-remove" @click="removeHashtag(index)">
                    ×
                  </button>
                </div>
              </div>
          ...
          <div v-if="editorMode === 'code'" class="code-editor">
            <div class="code-header">
              ...
              <div class="code-actions">
                <button class="code-btn format" @click="formatCode">
                  FORMAT
                </button>
                <button class="code-btn validate" @click="validateCode">
                  VALIDATE
                </button>
              </div>
            </div>
      ...
      <div class="preview-panel">
        ...
        <div v-if="previewMode === 'feed'" class="instagram-preview">
          <div class="instagram-post">
            <div class="post-header">
              <div class="profile-info">
                <div class="profile-avatar">
                  <img
                    src="https://picsum.photos/32/32?random=user"
                    alt="Profile"
                  />
                </div>
            ...
            <div
              class="post-media"
              v-if="selectedMedia !== null && mediaFiles[selectedMedia]"
            >
              <img
            ...
            <div class="post-content">
              ...
              <div
                class="hashtags-preview"
                v-if="postContent.hashtags.length > 0"
              >
                <span
                  class="hashtag"
        ...
        <div class="publishing-settings">
            ...
            <div class="radio-group">
              <label class="radio-option">
                <input
                  type="radio"
                  value="now"
                  v-model="publishSettings.schedule"
                />
          ...
          <div
            v-if="publishSettings.schedule === 'later'"
            class="setting-group"
          >
...
<script setup lang="ts">
  ...
  const canPublish = computed(() => {
    return (
      publishSettings.value.accountId &&
  ...
  const generateAICaption = async () => {
    ...
    postContent.value.caption =
      "Just dropped into the neural matrix 🤖✨ This AI-enhanced content is pushing the boundaries of digital creativity. The future is now, and we're coding it one post at a time! #DigitalRevolution";
