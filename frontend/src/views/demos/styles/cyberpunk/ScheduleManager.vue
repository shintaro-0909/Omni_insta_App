                ...
                <div class="track-header">
                  ...
                  <div class="track-stats">
                    <span class="posts-count"
                      >{{ account.scheduledPosts }} POSTS</span
                    >
                  </div>
                </div>
                ...
                <div class="track-timeline">
                  <div
                    ...
                    :class="[
                      ...
                      { 'glitch-active': schedule.isProcessing },
                    ]"
                  ...
                  >
                    <div class="schedule-content">
                      ...
                      <div class="schedule-indicators">
                        <span v-if="schedule.hasMedia" class="indicator media"
                          >📷</span
                        >
                        <span
                          v-if="schedule.isRecurring"
                          class="indicator recurring"
                          >🔄</span
                        >
                        <span v-if="schedule.hasAI" class="indicator ai"
                          >🤖</span
                        >
                      </div>
                    </div>
      ...
      <div v-if="selectedSchedule" class="panel-content">
        ...
        <div class="detail-section">
          ...
          <div class="detail-value">
            {{ getAccountName(selectedSchedule.accountId) }}
          </div>
        </div>
        ...
        <div class="detail-section">
          ...
          <div
            ...
            :class="'type-' + selectedSchedule.type"
          >
        ...
        <div class="detail-section">
          ...
          <div
            ...
            :class="'status-' + selectedSchedule.status"
          >
...
<script setup lang="ts">
  ...
  const calendarDays = computed(() => {
    ...
    for (let i = 0; i < 42; i++) {
      ...
      const daySchedules = schedules.value.filter(
        s => new Date(s.scheduledTime).toDateString() === date.toDateString()
      );
