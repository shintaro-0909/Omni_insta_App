        ...
        >
          <div class="card-header">
            ...
            <div class="account-info">
              ...
              <span class="account-type" :class="'type-' + account.type">{{
            ...
            <div class="account-actions">
              ...
              >
                <span class="icon" :class="{ spinning: account.refreshing }"
                  >🔄</span
                >
              </button>
              <button
                class="action-btn settings"
                @click.stop="openSettings(account.id)"
              >
                <span class="icon">⚙️</span>
              </button>
              <button
                class="action-btn disconnect"
                @click.stop="disconnectAccount(account.id)"
              >
            ...
            <div class="metrics-grid">
              <div class="metric-item">
                ...
                <div class="metric-trend" :class="account.followersTrend">
                  {{
                    account.followersTrend === 'up'
                      ? '↗'
                      : account.followersTrend === 'down'
                        ? '↘'
                        : '→'
                  }}
          ...
          <div class="card-engagement">
            <div class="engagement-header">
              ...
              <span
                ...
                :class="getEngagementClass(account.engagementRate)"
              >
            ...
            <div class="performance-grid">
              <div class="performance-card">
                ...
                <div class="performance-info">
                  <span class="performance-value neon-cyan"
                    >{{ selectedAccount.avgEngagement }}%</span
                  >
              ...
              <div class="performance-card">
                ...
                <div class="performance-info">
                  <span class="performance-value neon-magenta">{{
                    formatNumber(selectedAccount.avgReach)
                  }}</span>
              ...
              <div class="performance-card">
                ...
                <div class="performance-info">
                  <span class="performance-value neon-green">{{
                    formatNumber(selectedAccount.avgImpressions)
                  }}</span>
            ...
            <div class="growth-chart">
              ...
              <div class="chart-overlay">
                <div class="chart-stats">
                  <div class="stat-item">
                    <span class="stat-value neon-cyan"
                      >+{{ selectedAccount.monthlyGrowth }}%</span
                    >
            ...
            <div class="activity-feed">
              ...
              >
                ...
                <div
                  ...
                  :class="getValueClass(activity.value)"
                >
                  {{ activity.value }}
                </div>
              </div>
...
<script setup lang="ts">
  ...
  const accounts = ref([
    {
      ...
      aiInsights: [
        ...
        },
        {
          ...
          description:
            'Using #ai and #tech hashtags increases engagement by 23%',
          icon: '#️⃣',
          priority: 'medium',
          confidence: 87,
        },
  ...
  const verifyPermissions = () => {
    ...
    const syncInterval = setInterval(() => {
      ...
      if (
        messageIndex < syncMessages.length - 1 &&
        syncProgress.value > (messageIndex + 1) * 20
      ) {
        messageIndex++;
