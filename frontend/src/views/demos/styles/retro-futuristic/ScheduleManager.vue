          ...
          <div class="timeline-grid">
            <div class="time-slots">
              <div class="time-slot" v-for="hour in 24" :key="hour">
                <span class="time-label">{{ String(hour - 1).padStart(2, '0') }}:00</span>
...
const updateDateTime = () => {
  ...
  currentMonth.value = now.toLocaleString('en-US', { month: 'long' }).toUpperCase()
...
.neon-lines {
  ...
  inset: 0;
  background-image: 
    linear-gradient(90deg, transparent 49%, rgba(255, 0, 110, 0.1) 50%, transparent 51%);
...
@keyframes pulse-indicator {
  0%, 100% { transform: scale(1); box-shadow: 0 0 10px rgba(255, 0, 110, 0.5); }
  50% { transform: scale(1.2); box-shadow: 0 0 20px rgba(255, 0, 110, 0.8); }
}
...
@keyframes modal-glow {
  0%, 100% { box-shadow: 0 0 50px rgba(255, 0, 110, 0.5), inset 0 0 50px rgba(138, 43, 226, 0.1); }
  50% { box-shadow: 0 0 80px rgba(255, 0, 110, 0.8), inset 0 0 80px rgba(138, 43, 226, 0.2); }
}
