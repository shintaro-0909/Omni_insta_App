    ...
    <main class="pricing-main">
        ...
        >
          ...
          <div class="card-content">
            ...
            <button class="select-button" :class="{ glowing: plan.featured }">
              <span class="button-text">{{ plan.featured ? 'MOST POPULAR' : 'SELECT PLAN' }}</span>
      ...
      <section class="comparison-section">
        ...
        <div class="comparison-table">
          ...
          <div class="table-body">
            <div class="table-row" v-for="(feature, index) in comparisonFeatures" :key="index">
      ...
      <section class="cta-section">
        <div class="cta-content">
          ...
          <p class="cta-subtitle">Join thousands of users in the digital revolution</p>
...
const faqs = ref([
  {
    ...
    answer: 'Yes! You can seamlessly transition between plans at any time. Your data and settings will be preserved during the migration process.'
  },
  {
    question: 'Is there a free trial available?',
    answer: 'Absolutely! All new users get a 14-day free trial of our NEON plan to experience the full power of our platform.'
  },
  {
    question: 'What payment methods do you accept?',
    answer: 'We accept all major credit cards, cryptocurrency, and digital payment platforms from the future.'
  },
  {
    question: 'Can I cancel my subscription anytime?',
    answer: 'Of course! No long-term contracts. You can cancel your subscription at any time with no penalties.'
  }
])
...
.price-card.featured {
  border-color: #ff006e;
  background: linear-gradient(135deg, rgba(255, 0, 110, 0.1), rgba(26, 0, 51, 0.9));
}
...
@keyframes sun-breathe {
  ...
  50% { transform: translateX(-50%) scale(1.1); filter: blur(2px); }
}

@keyframes grid-scroll {
  0% { transform: perspective(500px) rotateX(70deg) translateY(0); }
  100% { transform: perspective(500px) rotateX(70deg) translateY(50px); }
}
...
@keyframes title-glow {
  0%, 100% { filter: brightness(1) drop-shadow(0 0 20px #ff006e); }
  50% { filter: brightness(1.2) drop-shadow(0 0 40px #ff006e); }
}
