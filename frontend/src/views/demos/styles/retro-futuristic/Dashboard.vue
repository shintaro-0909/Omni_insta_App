    ...
    <main class="dashboard-main">
        ...
        <div class="metrics-grid">
          <div class="metric-card" v-for="metric in metrics" :key="metric.id">
            <div class="metric-frame">
              ...
              <div class="metric-glow" :style="`background: ${metric.color}`"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="activity-section">
        ...
        <div class="activity-feed">
          <div class="log-entry" v-for="log in systemLogs" :key="log.id">
            ...
            <div class="log-type" :class="`type-${log.type}`">{{ log.type }}</div>
      ...
      <section class="control-section">
        ...
        <div class="control-grid">
          <button class="control-btn" v-for="control in controls" :key="control.id">
...
const systemLogs = ref([
  { id: 1, time: '23:45:12', type: 'SUCCESS', message: 'Post scheduled for @cyber_account' },
  { id: 2, time: '23:44:58', type: 'INFO', message: 'AI optimization complete' },
  { id: 3, time: '23:44:32', type: 'WARNING', message: 'API rate limit: 80% used' },
  { id: 4, time: '23:43:15', type: 'SUCCESS', message: 'Batch processing completed' },
  { id: 5, time: '23:42:47', type: 'INFO', message: 'System sync in progress' }
])
...
@keyframes glitch-text {
  0%, 100% { text-shadow: 0 0 30px #ff006e; }
  25% { text-shadow: -2px 0 30px #8338ec, 2px 0 30px #3a86ff; }
  50% { text-shadow: 2px -2px 30px #ff006e, -2px 2px 30px #ffbe0b; }
  75% { text-shadow: 0 0 30px #8338ec; }
}
