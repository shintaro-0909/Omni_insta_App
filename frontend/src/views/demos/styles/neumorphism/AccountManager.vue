        ...
        <div class="account-card" v-for="account in accounts" :key="account.id">
          ...
          <div class="account-analytics">
            <div class="analytics-header">
              ...
              <span
                class="growth"
                :class="account.growth > 0 ? 'positive' : 'negative'"
              >
                <i
                  :class="
                    account.growth > 0
            ...
            <div class="analytics-grid">
              <div class="metric">
                <div class="metric-value">
                  {{ formatNumber(account.analytics.likes) }}
                </div>
                <div class="metric-label">Likes</div>
              </div>
              <div class="metric">
                <div class="metric-value">
                  {{ formatNumber(account.analytics.comments) }}
                </div>
          ...
          <div class="quick-actions">
            ...
            <button
              class="quick-action schedule"
              @click="schedulePost(account)"
            >
        ...
        <div class="account-row" v-for="account in accounts" :key="account.id">
          ...
          <div class="col-followers">
            <div class="follower-info">
              ...
              <span
                class="growth"
                :class="account.followerGrowth > 0 ? 'positive' : 'negative'"
              >
                <i
                  :class="
          ...
          <div class="col-engagement">
            <div class="engagement-meter">
              <div class="meter-track">
                <div
                  class="meter-fill"
                  :style="{ width: account.analytics.engagement + '%' }"
                ></div>
              </div>
              <span class="percentage"
                >{{ account.analytics.engagement }}%</span
              >
            </div>
          </div>
          <div class="col-posts">
      ...
      <div class="connect-modal" @click.stop>
        ...
        <div class="modal-content">
          <div class="connect-steps">
            <div
              class="step"
              :class="{ active: connectStep === 1, completed: connectStep > 1 }"
            >
            ...
            <div
              class="step"
              :class="{ active: connectStep === 2, completed: connectStep > 2 }"
            >
          ...
          <div class="connect-content">
            <div v-if="connectStep === 1" class="step-1">
              <div class="connect-info">
                ...
                <p>
                  We'll redirect you to Instagram to authorize access to your
                  account. We only request the minimum permissions needed.
                </p>
                <ul class="permissions-list">
                  <li>
                    <i class="mdi mdi-check"></i> Read basic profile information
                  </li>
                  <li>
                    <i class="mdi mdi-check"></i> Publish posts and stories
                  </li>
                  <li>
                    <i class="mdi mdi-check"></i> Access insights and analytics
                  </li>
                </ul>
              </div>
            ...
            <div v-if="connectStep === 2" class="step-2">
              <div class="loading-state">
                ...
                <h4>Connecting...</h4>
                <p>
                  Please complete the authorization on Instagram and return
                  here.
                </p>
              </div>
            </div>
...
<script setup lang="ts">
  ...
  const totalPosts = computed(() => {
    return accounts.value.reduce(
      (sum, account) => sum + account.analytics.postsThisMonth,
      0
    );
  });
  ...
  const averageEngagement = computed(() => {
    const avg =
      accounts.value.reduce(
        (sum, account) => sum + account.analytics.engagement,
        0
...
<style scoped>
  ...
  .stat-card.followers .stat-icon i {
    color: #48bb78;
  }
  .stat-card.posts .stat-icon i {
    color: #ed8936;
  }
  .stat-card.engagement .stat-icon i {
    color: #e53e3e;
  }
  ...
  @media (max-width: 1024px) {
    ...
    .col-followers::before {
      content: 'Followers:';
    }
    .col-engagement::before {
      content: 'Engagement:';
    }
    .col-posts::before {
      content: 'Posts:';
