    ...
    <div v-if="currentView === 'timeline'" class="timeline-container">
      <div class="timeline-header">
        <div class="timeline-filters">
          ...
          <button
            class="timeline-filter"
            :class="{ active: timelineFilter === 'today' }"
            @click="timelineFilter = 'today'"
          >
            Today
          </button>
          <button
            class="timeline-filter"
            :class="{ active: timelineFilter === 'week' }"
            @click="timelineFilter = 'week'"
          >
            This Week
          </button>
          <button
            class="timeline-filter"
            :class="{ active: timelineFilter === 'month' }"
            @click="timelineFilter = 'month'"
          >
            This Month
          </button>
        </div>
      ...
      <div class="timeline-content">
        <div class="timeline">
          <div
            class="timeline-item"
            v-for="post in filteredTimelinePosts"
            :key="post.id"
          >
            <div
    ...
    <div v-if="selectedDay" class="modal-overlay" @click="closeModal">
      <div class="day-modal" @click.stop>
        <div class="modal-header">
          <h3>
            {{ selectedDay.number }} {{ currentMonthName }} {{ currentYear }}
          </h3>
        ...
        <div class="modal-content">
          <div class="schedule-form">
            ...
            <div class="form-actions">
              <button class="cancel-btn" @click="closeNewScheduleModal">
                Cancel
              </button>
              <button class="save-btn" @click="saveNewSchedule">
                Schedule Post
              </button>
            </div>
          </div>
    ...
    switch (timelineFilter.value) {
      ...
      case 'week':
        filtered = filtered.filter(post => {
          ...
          return (
            postDate >= weekStart &&
            postDate < new Date(weekStart.getTime() + 7 * 24 * 60 * 60 * 1000)
          );
        });
        break;
      case 'month':
