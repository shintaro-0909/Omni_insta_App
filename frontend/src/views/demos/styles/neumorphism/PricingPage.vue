  ...
  <div class="neumorphism-pricing">
    ...
    <section class="pricing-hero">
      <div class="hero-content">
        ...
        <p class="hero-subtitle">Choose the perfect plan for your Instagram growth journey</p>
        ...
        >
          ...
          <div class="plan-cta">
            ...
            >
              ...
              <span v-else>Start {{ isAnnual ? 'Annual' : 'Monthly' }} Plan</span>
            </button>
          ...
          >
            ...
            >
              <span v-if="typeof feature.plans[plan.id] === 'boolean'">
                <i 
                  :class="feature.plans[plan.id] ? 'mdi mdi-check check-yes' : 'mdi mdi-close check-no'"
                ></i>
              </span>
      ...
      <div class="faq-grid">
        ...
        >
          <div class="faq-question">
            <h4>{{ faq.question }}</h4>
            <i :class="activeFaq === faq.id ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'"></i>
          </div>
    ...
    <section class="final-cta">
      <div class="cta-content">
        ...
        <div class="cta-buttons">
          ...
          <button class="cta-secondary" @click="viewDemo">
            Watch Demo
          </button>
        </div>
      </div>
...
const comparisonFeatures = ref([
  ...
  },
  {
    ...
    plans: { free: '10', basic: '100', pro: '1,000', enterprise: 'Unlimited' }
  },
  {
  ...
  },
  {
    ...
    plans: { free: 'Basic', basic: 'Standard', pro: 'Advanced', enterprise: 'Custom' }
  },
  {
...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 'Absolutely. We use bank-level encryption and follow industry best practices to keep your data secure. We never store your Instagram passwords.'
  }
])
