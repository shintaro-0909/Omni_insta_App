    ...
    <header class="creator-header">
      <div class="header-content">
        <div class="title-section">
          ...
          <p class="page-subtitle">Design beautiful content for your Instagram</p>
        </div>
          ...
          <div class="upload-area" @click="triggerFileUpload" @dragover.prevent @drop.prevent="handleDrop">
            <div v-if="!uploadedMedia.length" class="upload-placeholder">
              ...
              <div class="supported-formats">
                <span v-if="mediaType === 'image'">JPG, PNG, GIF up to 10MB</span>
                <span v-if="mediaType === 'video'">MP4, MOV up to 100MB</span>
                <span v-if="mediaType === 'carousel'">Multiple photos up to 10 items</span>
              </div>
            </div>
            <div v-else class="uploaded-media">
              ...
              <div v-if="mediaType === 'carousel' && uploadedMedia.length < 10" class="add-more-media" @click.stop="triggerFileUpload">
                <i class="mdi mdi-plus"></i>
                <span>Add More</span>
              </div>
            </div>
          </div>
          <input ref="fileInput" type="file" multiple hidden @change="handleFileUpload" accept="image/*,video/*" />
        </div>
        ...
        <div class="preview-section">
          <div class="section-header">
            ...
            <div class="preview-controls">
              <button class="preview-control" :class="{ active: previewMode === 'feed' }" @click="previewMode = 'feed'">
                Feed
              </button>
              <button class="preview-control" :class="{ active: previewMode === 'story' }" @click="previewMode = 'story'">
                Story
              </button>
            </div>
          </div>
            ...
            <div class="instagram-preview" :class="previewMode">
              ...
              <div v-if="previewMode === 'feed'" class="feed-preview">
                <div class="post-header">
                  <div class="profile-info">
                    <div class="profile-avatar">
                      <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?w=32&h=32&fit=crop&crop=face" alt="Profile" />
                    </div>
                ...
                <div class="post-media">
                  <img v-if="selectedMedia && selectedMedia.type === 'image'" :src="selectedMedia.url" alt="Post media" />
                  <video v-if="selectedMedia && selectedMedia.type === 'video'" :src="selectedMedia.url" muted controls></video>
                ...
                <div class="post-caption">
                  <span class="username">{{ selectedAccount.username }}</span>
                  <span class="caption-text">{{ postData.caption || 'Write your caption...' }}</span>
                </div>
              </div>
              ...
              <div v-if="previewMode === 'story'" class="story-preview">
                ...
                <div class="story-media">
                  <img v-if="selectedMedia && selectedMedia.type === 'image'" :src="selectedMedia.url" alt="Story media" />
                  <video v-if="selectedMedia && selectedMedia.type === 'video'" :src="selectedMedia.url" muted></video>
                  <div v-if="!selectedMedia" class="no-media">
                    <i class="mdi mdi-image"></i>
                    <span>No media selected</span>
                  </div>
          ...
          <div class="account-selector">
            ...
            >
              ...
              <div class="account-info">
                ...
                <span class="account-followers">{{ account.followers }} followers</span>
              </div>
            ...
            <template v-if="showAdvanced">
              <div class="setting-item">
                ...
                <div class="setting-toggle">
                  <input type="checkbox" id="disable-comments" v-model="postData.disableComments" />
              ...
              <div class="setting-item">
                ...
                <div class="setting-toggle">
                  <input type="checkbox" id="hide-likes" v-model="postData.hideLikes" />
              ...
              <div class="setting-item">
                ...
                <div class="setting-toggle">
                  <input type="checkbox" id="paid-partnership" v-model="postData.paidPartnership" />
...
const generateSuggestions = () => {
  ...
  aiSuggestions.value = {
    captions: [
      { id: 1, text: '✨ Living my best life one day at a time. What\'s inspiring you today? #lifestyle #motivation' },
      { id: 2, text: 'Sometimes the smallest step in the right direction ends up being the biggest step of your life 💫' },
      { id: 3, text: 'Collecting moments, not things 📸 #memories #gratitude #blessed' }
    ],
    hashtags: [
      {
        name: 'Lifestyle',
        tags: ['lifestyle', 'daily', 'inspiration', 'motivation', 'blessed', 'gratitude']
      },
      {
        name: 'Photography',
        tags: ['photography', 'photooftheday', 'instadaily', 'picoftheday', 'capture', 'moment']
      },
      {
        name: 'Trending',
