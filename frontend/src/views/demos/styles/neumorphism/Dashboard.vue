        ...
        <div class="chart-card">
          <div class="card-header">
            ...
            <div class="chart-controls">
              <button class="chart-control" :class="{ active: activeChartPeriod === '7d' }" @click="activeChartPeriod = '7d'">7d</button>
              <button class="chart-control" :class="{ active: activeChartPeriod === '30d' }" @click="activeChartPeriod = '30d'">30d</button>
              <button class="chart-control" :class="{ active: activeChartPeriod === '90d' }" @click="activeChartPeriod = '90d'">90d</button>
            </div>
          </div>
          <div class="chart-container">
            <div class="chart-placeholder">
              <div class="chart-bars">
                <div class="bar" v-for="i in 12" :key="i" :style="{ height: Math.random() * 80 + 20 + '%' }"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="post-item" v-for="post in recentPosts" :key="post.id">
              ...
              <div class="post-details">
                ...
                <div class="post-stats">
                  ...
                  <span><i class="mdi mdi-comment"></i> {{ post.comments }}</span>
                </div>
              </div>
      ...
      <div class="right-column">
        ...
        <div class="performance-card">
          ...
          <div class="performance-list">
            <div class="performance-item" v-for="account in accounts" :key="account.id">
        ...
        <div class="schedule-card">
          ...
          <div class="schedule-list">
            <div class="schedule-item" v-for="item in upcomingPosts" :key="item.id">
...
const recentPosts = ref([
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=60&h=60&fit=crop',
    likes: '1.2K',
    comments: '89',
    status: 'published'
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=60&h=60&fit=crop',
    likes: '856',
    comments: '42',
    status: 'scheduled'
  },
  {
    ...
    account: '@sarahlifestyle',
    thumbnail: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=60&h=60&fit=crop',
    likes: '923',
    comments: '67',
    status: 'published'
  }
