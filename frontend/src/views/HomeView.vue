        ...
        <v-row align="center" justify="center" class="min-height-100vh">
          <v-col cols="12" md="8" lg="6" class="text-center">
            ...
            <p class="hero-subtitle mb-8">
              ...
              <strong>定期投稿・ランダム投稿・複数アカウント管理</strong
              >が簡単に。
            </p>
      ...
      <v-container class="py-16">
        <v-row>
          <v-col cols="12" class="text-center mb-12">
            <h2 class="section-title gradient-text mb-6">なぜOmniyなのか？</h2>
        ...
        <v-row class="stats-section mt-16">
          <v-col cols="12" class="text-center mb-8">
            <h3 class="text-h4 font-weight-bold mb-8">数字で見るOmniyの効果</h3>
          </v-col>
