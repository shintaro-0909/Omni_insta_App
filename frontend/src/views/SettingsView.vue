                ...
                <v-list density="compact">
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >投稿が正常に完了した時に通知</v-list-item-subtitle
                    >
                    <template #append>
                      <v-switch
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >投稿が失敗した時に通知</v-list-item-subtitle
                    >
                    <template #append>
                      <v-switch
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >メンテナンスやアップデート情報</v-list-item-subtitle
                    >
                    <template #append>
                      <v-switch
              ...
              <div class="general-settings">
                ...
                <v-list density="compact">
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >画面テーマを切り替え</v-list-item-subtitle
                    >
                    <template #append>
                      <v-switch
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle
                      >データの自動更新間隔</v-list-item-subtitle
                    >
                    <template #append>
                      <v-select
          ...
          <v-card class="settings-card" elevation="0" rounded="xl">
            ...
            <v-card-text class="pa-6">
              <div class="d-flex justify-space-between align-center">
                ...
                <v-btn color="primary" variant="outlined" to="/billing">
                  プラン変更
                </v-btn>
              </div>
            </v-card-text>
